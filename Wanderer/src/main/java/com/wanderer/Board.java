...
public class Board extends JComponent implements KeyListener {
    ...
    public static BufferedImage currentSide;
    public static Hero hero = new Hero();
    public static Boss boss = new Boss();
    public static Skeleton skeleton1 = new Skeleton();
    public static Skeleton skeleton2 = new Skeleton();
    public static Skeleton skeleton3 = new Skeleton();
    public MapGenerator map = new MapGenerator();
    static final int TILE_SIZE = 72;
    public static List<Skeleton> skeletonList = new ArrayList<>(List.of(skeleton1, skeleton2, skeleton3));
    ...
    public void paint(Graphics graphics) {
        ...
        String infoPannel = "Hero  (Level  " + hero.getLVL() + ")  HP:  " + hero.getHP() + "/" + hero.getMaxHP() + "  |  DP:  " + hero.getDP() + "  |  SP:  " + hero.getSP();
    ...
    public void keyReleased(KeyEvent e) {
        if (hero.isAlive() && !inCombat) {
            ...
            switch (map.mapArr[hero.getHeroPositionX() / TILE_SIZE][hero.getHeroPositionY() / TILE_SIZE]) {
                case 5 -> {
